...
const UserModule = () => {
  ...
  const handleLogout = () => {
    ...
    setBookingSuccess(null); // Add this
  ...
  // --- VIEW 1: Logged In (Movie Browsing or Booking Flow) ---
  if (selectedUser) {
    return (
            ...
            <>
              ...
              {selectedMovie && !selectedShow && (
                ...
                >
                  ...
                  <TheatreShowtimes
                    movie={selectedMovie}
                    onSelectShow={(show, theatre, screen) => {
                      setSelectedShow({ show, theatre, screen });
                    }}
                  />
                </div>
              )}

              {/* STATE 3: Select Seats */}
                  ...
                  >
                    ...
                    <div>
                      ...
                      >
                        ...
                        {selectedShow.screen.screen_name} |{" "}
                        {new Date(selectedShow.show.show_time).toLocaleString(
                          [],
                          {
                            dateStyle: "medium",
                            timeStyle: "short",
              ...
              {/* STATE 4: Payment Gateway Simulation */}
              {bookingSuccess && (
                <div
                  style={{
                    display: "flex",
                ...
                >
                  <PaymentSimulation
                    ...
                    onComplete={() => {
                      // Clean up state to return to home screen after success
                      setSelectedMovie(null);
                      setSelectedShow(null);
                      setBookingSuccess(null);
                      // Optional: Switch to bookings tab automatically after success
                      setActiveTab("bookings");
                    }}
                    onCancel={() => {
                      // Clean up state to return to seat map after failure
                      setBookingSuccess(null);
                    }}
                  />
                </div>
  ...
  // --- VIEW 2: Not Logged In (Select / Create User) ---
  return (
...
// Replaced fixed height with minHeight so it breathes better on smaller screens
const moduleWrapper = {
  display: "flex",
  minHeight: "550px",
  background: "#111",
...
// Made it taller (85vh) and gave it a generous max-height for large monitors
const moduleWrapperLarge = {
  display: "flex",
  flexDirection: "column",
  height: "85vh",
  minHeight: "650px",
